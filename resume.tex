...
%-------------------------------------------
    \resumeSubheading
      {Codiga}{Remote, USA}
      {Software Engineer (Contract)}{Feb 2022 -- Present}
      \resumeItemListStart
        \resumeItem{Reduced build times by 2x by writing deployment scripts and configuring lerna workspace in monorepo. }
        \resumeItem{Decreased the build size by 3x, by building Component Library using Chakra UI, Rollup and Typescript. }
        \resumeItem{Number of adoptions increased by 1.5x by advising to Developer Marketing Team.}
